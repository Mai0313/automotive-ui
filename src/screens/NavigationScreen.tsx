    ...
    <RNSafeAreaView style={commonStyles.container}>
      ...
      <View style={styles.navigationPanel}>
        <View style={styles.routeInfo}>
          <View style={styles.directionItem}>
            <MaterialIcons color="#3498db" name="directions" size={24} />
          ...
          <View style={styles.directionItem}>
            <MaterialIcons color="#3498db" name="arrow-forward" size={24} />
            <View style={styles.directionText}>
      ...
      <View style={styles.mapControls}>
        <TouchableOpacity style={styles.mapControl}>
          <MaterialIcons color="#fff" name="add" size={30} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.mapControl}>
          <MaterialIcons color="#fff" name="remove" size={30} />
        </TouchableOpacity>
      </View>
    </RNSafeAreaView>
  );
